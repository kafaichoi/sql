...
defmodule SQL.String do
  ...
  def token_to_sql({tag, _, [{:parens, _, _} = value]}, mod)
  ...
  def token_to_sql({tag, _, value}, mod)
  ...
  def token_to_sql({tag, _, [left, [{:all = t, _, right}]]}, mod)
  ...
  def token_to_sql({tag, _, [left, right]}, mod)
  ...
  def token_to_sql({tag, _, values}, mod)
